...
export default function ElementShapeGroup ({layer}) {
    ...
    layer.__resolved.shapegroup = {
        ...
        borderRadius: childLayers[0]._class === 'rectangle' || childLayers[0]._class === 'oval'? (childLayers[0].points || childLayers[0].path.points).map(p => p.cornerRadius).join(', ') : undefined
    };
